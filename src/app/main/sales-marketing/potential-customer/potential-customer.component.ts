...
import { ModalPotentialCustomerComponent } from '@app/shared/components/sales-marketing/modal-potential-customer/modal-potential-customer.component';
...
import { Branch, Customer, Employee, Pagination, PotentialCustomer, ResponseValue } from '@app/shared/models';
import { SalesCustomer } from '@app/shared/models/sales-marketing/sales-customer.model';
import { AuthService, BranchService, EmployeeService, NotificationService,  PotentialCustomerService } from '@app/shared/services';
