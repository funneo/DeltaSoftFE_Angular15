...
@Component({
  selector: 'app-shipping-task-opman',
  templateUrl: './shipping-task-opman.component.html',
  styleUrls: ['./shipping-task-opman.component.css']
})
export class ShippingTaskOpmanComponent implements OnInit {
  pageIndex=1;
  flagDelete = false;
  keyword = '';
