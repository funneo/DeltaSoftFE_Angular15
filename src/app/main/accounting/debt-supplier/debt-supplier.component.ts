...
import { Debt, Pagination, ResponseValue, Customer, Supplier, Branch } from '@app/shared/models';
...
@Component({
  selector: 'app-debt-supplier',
  templateUrl: './debt-supplier.component.html',
  styleUrls: ['./debt-supplier.component.css']
})
export class DebtSupplierComponent implements OnInit {
  ...
  export(){
    let printList=this.listFilter.map(({ id,branchId,employeeId,
        ...
        this._export.exportExcel(printList,'cong-no-phai-tra');
  }
