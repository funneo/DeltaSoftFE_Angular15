...
import { ModalDebitNoteCanonComponent } from '@app/shared/components/canon/modal-debit-note-canon/modal-debit-note-canon.component';
...
import { ReportViewModel, Customer, Branch, ResponseValue, Pagination, DebitNotes } from '@app/shared/models';
import { NotificationService, UtilityService, ReportsService, AuthService, CustomerService, BranchService, DebitNotesService } from '@app/shared/services';
...
@Component({
  selector: 'app-db-chitiet-canon',
  templateUrl: './db-chitiet-canon.component.html',
  styleUrls: ['./db-chitiet-canon.component.css']
})
export class DbChitietCanonComponent implements OnInit {
  ...
  tienteSearch:string='';
  hoadonDelta='';
  @ViewChild(ModalDebitNoteCanonComponent, { static: false }) modalDebitNote: ModalDebitNoteCanonComponent
