import { IgasData } from './../../../models/transports/igas-data.model';
import { HttpParams } from '@angular/common/http';
import { Component, EventEmitter, OnInit, Output, ViewChild } from '@angular/core';
import { NgForm } from '@angular/forms';
import { MessageContstants } from '@app/shared/constants';
import { Accounts, Branch, Customer, Employee, ResponseValue, AccountList, AccountingDetail, OtherCategories, Supplier, PrintForm } from '@app/shared/models';
import { NotificationService, AccountsService, BranchService, CustomerService, AuthService, UtilityService, EmployeeService, AccountListService, OtherCategoriesService, PaymentsService } from '@app/shared/services';
...
@Component({
  selector: 'modal-phieu-thu',
  templateUrl: './modal-phieu-thu.component.html',
  styleUrls: ['./modal-phieu-thu.component.css']
})
export class ModalPhieuThuComponent implements OnInit {
  entity: Accounts;
  ...
  constructor(private _notificationService: NotificationService, private accountsService: AccountsService, private paymentService: PaymentsService,
  ...
  add(item: any = null) {
    ...
    if (item != undefined && item != null) {
      ...
      this.entity.paymentDetailId = item?.paymentDetailId
  ...
  // thanhTien(hangmuc: any) {
  //   if (hangmuc?.khoiLuong && hangmuc?.donGia) {
  //     hangmuc.thanhTien = hangmuc.khoiLuong * hangmuc.donGia;
  //     this.tinhTongTien();
  //   }
  // }
