...
import { Advance, Branch, Employee, ResponseValue, AdvanceGroup, OtherCategories, Customer, Supplier } from '@app/shared/models';
import { NotificationService, AdvanceService, BranchService, AuthService, UtilityService, EmployeeService, AdvanceGroupService, OtherCategoriesService, CustomerService, SupplierService } from '@app/shared/services';
...
@Component({
  selector: 'modal-advance',
  templateUrl: './modal-advance.component.html',
  styleUrls: ['./modal-advance.component.css']
})
export class ModalAdvanceComponent implements OnInit {
  entity: Advance;
  ...
  constructor(private _notificationService: NotificationService, private advanceService: AdvanceService,
    private branchService: BranchService, private employeeService: EmployeeService, private authService: AuthService, private customerService: CustomerService,
    private _utilityService: UtilityService, private advanceGroupService: AdvanceGroupService, private otherCategoriesService: OtherCategoriesService, private supplierService: SupplierService) {
