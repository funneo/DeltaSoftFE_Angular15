...
@Component({
  selector: 'modal-view-shipping-task',
  templateUrl: './modal-view-shipping-task.component.html',
  styleUrls: ['./modal-view-shipping-task.component.css']
})
export class ModalViewShippingTaskComponent implements OnInit {
public entity: ShippingTask;
  ...
  viewShipmentContSeal() {
    console.log(this.shipmentSelected);
