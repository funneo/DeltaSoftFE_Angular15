...
import { Branch, Employee, Fee, DebitNoteDetail, DebitNotes, ResponseValue, Supplier, Shipment, Customer, RatingCS, PaymentDetail, Payments, OtherCategories, PrintForm, PermissionCS, Profile } from '@app/shared/models';
import { Router } from '@angular/router';
import { Observable, Subscription } from 'rxjs';
import { AuthService, BranchService, EmployeeService, FeeService, NotificationService, DebitNotesService, UtilityService, ShipmentService, CustomerService, PaymentsService, OtherCategoriesService, PermissionCSService } from '@app/shared/services';
...
@Component({
  selector: 'modal-debit-notes',
  templateUrl: './modal-debit-notes.component.html',
  styleUrls: ['./modal-debit-notes.component.css']
})
export class ModalDebitNotesComponent implements OnInit {
  flagXem: boolean;
  _type: number;
  _shipmentId: number;
