...
## Fix double dữ liệu khi Duyệt nháp ERP (race condition ở AddFromDraft) — ✅ ĐÃ chạy SQL + build/publish (anh xác nhận 2026-08-20), CHỜ TEST — 2026-08-19
...
- **✅ ĐÃ chạy SQL + tắt API build/publish** (anh xác nhận 2026-08-20). **CÒN**: test 2 tab/2 tài khoản duyệt trùng 1 nháp xác nhận chỉ 1 bản ghi thật; test "Duyệt nhiều" bình thường không regression; test case tạo lỗi giữa chừng → nháp trả về `Draft` (không kẹt `Promoting`).
