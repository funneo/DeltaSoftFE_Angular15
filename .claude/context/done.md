...
## FCL — Phân quyền CHỐT LỆNH theo KH: 3 fix UI trang quản lý (màu nút + dropdown tài khoản trắng + list KH tràn cột) — FE-only, CHỜ ng build — 2026-08-21
...
- **CÒN**: gộp chung nhịp `ng build` deploy FE với phần SQL/BE của tính năng này (xem section dưới — SQL vẫn CHỜ CHẠY).

## FCL — Phân quyền CHỐT LỆNH theo khách hàng — SQL soạn xong CHỜ CHẠY + BE/FE build sạch (đủ cả trang quản lý) — 2026-08-20
