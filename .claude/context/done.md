...
- **CÒN**: anh test thật với ảnh container thật (chụp vài góc) → xác nhận độ chính xác + badge check-digit đúng, rồi quyết định nơi gắn chính thức (field nào, màn nào).
