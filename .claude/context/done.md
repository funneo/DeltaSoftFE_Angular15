...
- **⬜ CÒN**: **tắt API + `dotnet publish`** (Model C# đổi) → `ng build` production deploy FE → test: mở lịch sử 1 lệnh từng bị từ chối ở bước chốt lệnh → cột "Bước" hiện đúng "Từ chối chốt lệnh", "Người thực hiện" có tên.
